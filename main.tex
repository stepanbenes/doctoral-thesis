...
\usepackage[backend=bibtex,style=numeric,natbib=true,sorting=none]{biblatex} % Use authoryear citation style for "Author, year" citation style
...
\author{Ing. \v{S}t\v{e}p\'{a}n Bene\v{s}} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
of my supervisor prof. Ing. Jaroslav Kruis, Ph.D. at the Czech Technical University in Prague, Faculty
...
%\include{appendices/2-user-guide}
%\include{appendices/3-TeX}

%----------------------------------------------------------------------------------------
%	BIBLIOGRAPHY
%----------------------------------------------------------------------------------------

\nocite{*} % check for unused references (package refcheck); comment out for filter out unused references
