...
\begin{figure}[H]
    ...
    \decoRule
    \caption{Visualization of a master layer with displacements in in Z axis.}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \decoRule
        \caption{Visualization of a deformation layer with displacements in in Z axis.}
    ...
    \begin{figure}[H]
        ...
        \decoRule
        \caption{Visualization of multiple slice layers with displacements in X axis.}
    ...
    \begin{figure}[H]
        ...
        \decoRule
        \caption{Visualization of multiple iso-surface layers with displacements in X axis.}
...
% TODO: Krome vrstev, ktere jsou reseny na serveru, post-processor musi umet nekolik veci, ktere nelze reprezentovat persistentne ve storage formatu: barevna skala, vektorove veliciny - je treba nacist vice komponent najednou (to je jedine, kdy je to potreba). 
...
Figure \ref{fig:beam-isoareas-shader}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/chapter-data-management/beam-isoareas-shader}
    \decoRule
