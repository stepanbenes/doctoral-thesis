...
% TODO: vice o vstupnim modelu. zminit modeller a OOFEM-link, ukazka db modelu
% TODO: model attributes: viz clanek FEA with Relational DB, section FEA Data and Dataflow
...
% Pojmout tuto kapitolu jako detailni specifikaci formatu. Inspirovat se dokumentem GiD postprocess format a take C# proposals na githubu
...
% ke kazdemu typu filtru pridat obrazek z postprocessoru at je to zajimavy (co ale dat do Results kapitoly?)
