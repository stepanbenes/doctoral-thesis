...
The Project entity holds the basic information about the analysis, such as its name, the owner, and the list of other users that have access permissions. The Project has relations to the list of simulations. The Simulation entity encapsulates the information ...

% Centrem vseho je entita projekt, projekt ma uzivatele vlastnika a muze mit nekolik dalsich lidi, kteri maji pristup k projektu (ruzna prava, pro cteni ci pro zapis...)
