...
The components of the data management system and their relations were outlined in Figure \ref{fig:FEA-architecture} and Figure \ref{fig:FEA-workflow}. This section discusses the implementation details of the application components based on the system design set out in the previous sections. The implementation of each component is discussed, including the languages, technologies, external providers, or libraries used in the application.

% architektura je modularni, muze to bezet lokalne, pokud to chci v cloudu, tak to rozsirim o dalsi infrastrukturu - web api service, database, web postprocessor...

\subsection*{Project data storage}
%- Relational database

% TODO: tohle asi patri do kapitoly o designu, hned za ER diagram se simulation results, ne sem. Presunout. Do teto kapitoly zadne konceptualni diagramy nedavat, jen natvrdo vyjmenovat technologie.
