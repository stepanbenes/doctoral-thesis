...
% TODO: pridat obecny uvod (zadne okecavani, primo k veci, ale jen k tem zakladnim principum)
% Zopakovat, ze pred popisem samotneho formatu pro reprezentaci vysledku z MKP, je treba popsat architekturu celeho FEA systemu, ktery tyto data produkuje a se kterou to musi byt kompatibilni
% Architektura je prototyp, na kterem se ma predvest system pro reprezentaci vysledku z FEM. Abych to zasadil do kontextu, popisu nejprve tuto architekturu.
...
% TODO: Client applications: either desktop (feature-rich) or web application(simple, basic control over calculation, presentation of resultsů; cross-platform, everywhere without installation)
