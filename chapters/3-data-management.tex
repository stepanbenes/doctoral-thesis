...
\begin{itemize}
    ...
    % Deformation // zminit Fallback property
    
    Figure \ref{fig:beam-deformation-layer}
    ...
    \begin{figure}[H]
        ...
        \decoRule
        \caption{Example of the attribute selection layer visualization.}
    ...
    \begin{figure}[H]
        ...
        \decoRule
        \caption{Example of the surface layer visualization.}
