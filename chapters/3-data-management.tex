...
Microsoft SQL Server is used as the underlying relational database management system, specifically, its cloud-based version that runs as platform-as-a-service in Microsoft Azure cloud.
