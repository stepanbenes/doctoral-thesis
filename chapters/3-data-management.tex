...
% Vstup do FEMu (geometricky model v teto architekture muze byt reprezentovan bud vstupnim souborem vygenerovanym v CADu nebo muze byt ulozen)
% In addition to that the desktop postprocessor ma moznost ukladat si data lokalne

% zminit, ze ukladat model v relacni databazi asi neni idealni, ma to sve nevyhody, ale pro ty projektova data to je fajn. Kam ukladat model? Taky do No-SQL databaze? Diskutovat vyhody a nevyhody
