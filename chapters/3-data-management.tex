...
\begin{itemize}
    ...
    \item \textbf{Slice} -- 
    % Slice // cross-section, zminit multiple parallel slices
    ...
    % AttributeSelection // e.g. elements with specific property (material property) - TODO: pridat obrazek beamu s AttributeSelection filtrem, s viditelnyma 1D prvkama
