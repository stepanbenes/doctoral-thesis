...
Figure \ref{fig:web-post-processor-mobile}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{figures/chapter-data-management/web-post-processor-mobile}
    \decoRule
    \caption{Web post-processor screenshot taken on a mobile device.}
    \label{fig:web-post-processor-mobile}
\end{figure}
