...
% popsat prototyp, ktery vytvarim ja - vyjmenovat z toho casti, ktere jsou funkcni, co jsem implementoval a co ne - modeller jsem nedelal, solver jsem pouzil existujici, focus je hlavne na konverzi vysledku a na post-processingu. V dalsi casti se bude hovorit jen o techto dvou postprocessorech, o konvertor
...
% TODO: Project-based data representation - prejmenovat tuto kapitolu? Neni to jen o Project-based datech. Mluvi se zde i o vstupnim modelu a o reprezentaci vysledku - vrstvy
\section{Project database schema}
