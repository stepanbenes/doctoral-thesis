...
The visualization of the example is in Figure \ref{fig:beam-master-layer}.
...
% TODO: The implemented filters are:
...
\begin{itemize}
    ...
    % AttributeSelection // e.g. elements with specific property (material property) - TODO: pridat obrazek vybarvene site se zapnutym zobrazovanim ElementProperty
    \item \textbf{AttributeSelection} -- 
    % Surface, // surface of the mesh, dulezite pro webovy post-procesor
    \item \textbf{Surface} -- 
    % IsoSurface // surface with constant data value
    \item \textbf{IsoSurface} -- 
\end{itemize}
...
% TODO: barevna skala, prepinani skalarnich velicin, vektorove veliciny - je treba nacist vice komponent najednou (to je jedine, kdy je to potreba). Dekomprese: prenasobeni matic - staci jeden radek. ...
