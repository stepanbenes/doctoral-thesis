...
The application is written in C\# language and targets full .NET framework. It supports both Microsoft Windows OS and Linux OS (tested on Debian-based Linux distributions; Mono\footnote{\todo{TODO: Mono framework URI}} framework is required). It uses OpenTK\footnote{\todo{TODO: OpenTK URI}} library for 3D visualizations, which is a low-level wrapper around OpenGL.
