...
This section contains screenshots and performance evaluation of both the desktop post-processor and the web post-processor. Both post-processors have the ability to connect to the remote web API, retrieve the list of solutions stored in the database, and visualize the results of the same simulation.
